...
The following 247code assets are the single source of truth for parity checks and
must be treated as immutable reference outputs (never modify or regenerate in-place):
